...
For instance, here, we define a new value `shallowwater` (plotted in light blue) for the attribute `habitat`,
...
Again, note that the changes made to the graph have to be saved in an object (using `<-`) to be
effective.
