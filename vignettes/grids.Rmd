...
full_graph <- setCosts(full_graph, 
                       method = "fun", 
                       attr.name = "habitat", 
                       method = "function",
                       FUN = exp.cost,
...
land_graph <- dropDeadEdges(full_graph, thres =5)
