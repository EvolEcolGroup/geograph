...
```
The object `paths` contains the identified paths, which are stored as a list with class `gPath` (see `?gPath`). @TODO currently refers to the grid version of gPath
